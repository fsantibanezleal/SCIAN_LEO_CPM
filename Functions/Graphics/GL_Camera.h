...
private:
	...
	int ID_VENTANA;
public:
	GL_Camera(float positionX, float positionY, float positionZ);
	~GL_Camera(void);
...
// ROTATION
	...
	void SetParametrosHapticos(point_3D _h_Eye,point_3D _h_Center,point_3D _h_Up);
	...
	point_3D GetCamUp(void){return camUp;}
	point_3D GetCamJ(void){return camJ;}
	point_3D GetCamK(void){return camK;}
	point_3D GetCamI(void){return camI;}
