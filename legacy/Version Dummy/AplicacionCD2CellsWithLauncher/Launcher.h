...
namespace AplicacionCD2Cells {
	...
	//public: Mascara		^_ventanaMascara; crear el puntero a la segunda ventana
	public: VentanaPrincipal	^_ventanaControl;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"Gestor Sistema: Dinamic Hot System v 0.3.3 >>----> Temp Stop: Confirgurable Fill Screen and Size Mask (Trouble: Null Mask create tramps)";
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) 
			 {
				...
				this->Hide();
				_ventanaControl =	gcnew VentanaPrincipal();
